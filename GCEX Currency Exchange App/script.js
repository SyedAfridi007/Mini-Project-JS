...
let currencyExchange = [
  {
    ...
    currencyName: "taka",
    buyExchangeRate: 0.012,
    sellExchangeRate: 86.8,
  },
  {
    countryName: "india",
    currencyName: "rupee",
    buyExchangeRate: 0.013,
    sellExchangeRate: 72.22,
  },
  {
    countryName: "usa",
    currencyName: "usd",
  ...
  },
  {
    ...
    sellExchangeRate: 0.95,
  },
  {
    countryName: "china",
    currencyName: "yuan",
    buyExchangeRate: 0.15,
    sellExchangeRate: 6.73,
  },
];
...
purchaseBtn.addEventListener("click", function (e) {
  ...
  currencyExchange.forEach((mov) => {
    ...
    if (sellCurrency == mov.currencyName) {
      sellCurAmount = mov.sellExchangeRate;
      console.log(sellCurAmount);
    }
  });

  let amount = buyCurAmount * purchaseAmount;
  console.log(amount);
